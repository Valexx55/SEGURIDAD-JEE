...
public class CallbackController {
    ...
    private void mostrarInfoTokenJwt (TokenAuthentication tauth, Tokens token)
    {
    	System.out.println("TOKEN ID = " + token.getIdToken());
    	System.out.println("CREDENCIALES = " + tauth.getCredentials());
    	System.out.println("NAME PRINCIPAL = " + tauth.getName());
    }
    ...
    private void handle(HttpServletRequest req, HttpServletResponse res) throws IOException {
        try {
            ...
            mostrarInfoTokenJwt(tokenAuth, tokens);
