...
public class ServletApiController {
	...
	//private String anulo;//provocar fallo de gestión central de errores
	
	@RequestMapping(value = "/comentar", method = RequestMethod.GET)
	public String comentar (HttpServletRequest request)
	{
		
		//int longi = anulo.length();
		
		HttpSession sesion = request.getSession(false);
		if (sesion!=null)
		{
			System.out.println(sesion.getId());
			sesion.setAttribute("nombre", "JAVI");
		}
	...
	public ModelAndView publica (@RequestParam (name="comentario") String comentario, ModelAndView respuesta)
	{
		System.out.println("COMENTARIO RECIBIDO = " + comentario);
		
		respuesta.addObject("comentario", comentario);
		respuesta.setViewName("verpublicados");
